export interface Question {
  ...
  explanation: string;
  category: 'Public Service Rules' | 'Scheme of Service' | 'Health Policies & KADCHMA' | 'HR & Disciplinary Procedures' | 'Financial & Procurement Rules';
...
export const QUESTION_POOL: Question[] = [
  ...
  },
  {
    ...
    options: [
      { key: 'A', text: "-20°C to -40°C exclusively" },
      { key: 'B', text: "+2°C to +8°C" },
      { key: 'C', text: "+15°C to +25°C" },
      { key: 'D', text: "+37°C" }
    ],
    correctAnswer: 'B',
    explanation: "Vaccine cold chain refrigerators at health facility levels must maintain temperatures consistently between +2°C and +8°C to preserve vaccine potency.",
    category: 'Health Policies & KADCHMA',
    targetGrades: ['07-10'],
